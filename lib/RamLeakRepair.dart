...
class RamLeakRepairProfile extends StatefulWidget {
  ...
  const RamLeakRepairProfile({super.key, 
    required this.name,
...
class RamLeakRepairPage extends StatelessWidget {
  const RamLeakRepairPage({super.key});

  @override
  Widget build(BuildContext context) {
    return const RamLeakRepairProfile(
      name: 'Ram Thapa',
      experience: '10 years of experience in leak repair services.',
      rating: 4.9,
      bio:
          'Ram Thapa has been providing professional leak repair services for over a decade. He specializes in detecting and fixing leaks with precision and efficiency, ensuring that your plumbing systems are secure and functional.',
      services: [
      ...
      reviews: [
        {
          ...
          'reviewText':
              'Ram did a fantastic job fixing our leaking pipes. He was quick, efficient, and very knowledgeable.',
        },
        {
        ...
        {
          'reviewerName': 'Santosh Shrestha',
          'reviewText':
              'Ram\'s expertise in leak repair is unmatched. Our toilet leak was resolved in no time.',
        },
      ],
